...
public class Demo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String bucketName = "sheeta1998-test";
        // 填写Object完整路径，完整路径中不能包含Bucket名称，例如exampledir/exampleobject.txt。
        String objectName = "image/001.jpg";
...
// </editor-fold>
        try {
            // 填写字符串。
            String filePath ="C:\\Users\\sheeta1998\\Pictures\\Camera Roll\\Snipaste_2025-09-16_17-03-21.png";
